...
while flag <= 100:
    ...
    for key in viewkey:
        headers = {'Accept-Language': 'zh-CN,zh;q=0.9',
                   'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.37 (KHTML, like Gecko) Chrome/51.0.2704.106 Safari/537.37',
        ...
        print(base_req.url)
        # print(str(base_req.content, 'utf-8', errors='ignore'))
